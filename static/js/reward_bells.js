...
function load_bells() {
    $.ajax({
        ...
        success: function (data) {
            ...
            card_5.innerHTML = "<th scope='row'>5 Bells</th><td>" + data.Card_5_Left + "</td>";

            card_4 = document.createElement("tr");
            card_4.innerHTML = "<th scope='row'>4 Bells</th><td>" + data.Card_4_Left + "</td>";

            card_3 = document.createElement("tr");
            card_3.innerHTML = "<th scope='row'>3 Bells</th><td>" + data.Card_3_Left + "</td>";
